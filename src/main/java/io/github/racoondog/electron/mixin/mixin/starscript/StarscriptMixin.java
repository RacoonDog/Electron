...
public abstract class StarscriptMixin implements IStarscript {
    ...
    /**
     * Alternate version of {@link Starscript#run(Script, StringBuilder)} that ignores {@link meteordevelopment.starscript.Section} instructions and return a {@link String}. Used when text cannot be colored.
     *
     * @author Crosby
     * @since 0.2.4
     */
    @Override
    public String rawRun(Script script, StringBuilder sb) {
        stack.clear();
